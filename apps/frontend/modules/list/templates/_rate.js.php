<script type="text/javascript" charset="utf-8">
  $(document).ready(function(){
    $('.list-item-<?php echo $item["id"] ?> .thumbs_rating a').click(function(){
      ...
      $('.list-item-<?php echo $item["id"] ?> .thumbs_rating').load(
          ...
          function() { 
            $('.list-item-<?php echo $item["id"] ?> .messages').html("Thank you for your input").addClass('notice').show("normal").parent().css('display', 'block');
