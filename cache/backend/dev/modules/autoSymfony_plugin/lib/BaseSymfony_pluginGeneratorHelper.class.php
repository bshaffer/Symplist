...
/**
 * symfony_plugin module configuration.
 *
 ...
 */
class BaseSymfony_pluginGeneratorHelper extends sfModelGeneratorHelper
{
  ...
  {
    return 'list' == $action ? 'symfony_plugin' : 'symfony_plugin_'.$action;
  }
}
