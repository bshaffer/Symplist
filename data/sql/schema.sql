...
CREATE TABLE community_list_item (id BIGINT AUTO_INCREMENT, title VARCHAR(255) NOT NULL, body LONGTEXT, list_id BIGINT, score BIGINT, count BIGINT, submitted_by INT, created_at DATETIME, updated_at DATETIME, INDEX list_id_idx (list_id), INDEX submitted_by_idx (submitted_by), PRIMARY KEY(id)) ENGINE = INNODB;
