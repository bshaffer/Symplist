...
CREATE TABLE plugin_release (id BIGINT AUTO_INCREMENT, plugin_id BIGINT, version VARCHAR(10), date DATETIME, symfony_version_min VARCHAR(10), symfony_version_max VARCHAR(10), summary LONGTEXT, stability VARCHAR(30), readme LONGTEXT, dependencies VARCHAR(255), INDEX plugin_id_idx (plugin_id), PRIMARY KEY(id)) ENGINE = INNODB;
