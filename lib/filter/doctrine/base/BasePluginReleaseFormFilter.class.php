...
class BasePluginReleaseFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'symfony_version_min' => new sfValidatorPass(array('required' => false)),
      'symfony_version_max' => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      ...
      'version'             => 'Text',
      'date'                => 'Date',
      'symfony_version_min' => 'Text',
      'symfony_version_max' => 'Text',
      'summary'             => 'Text',
      'stability'           => 'Text',
      'readme'              => 'Text',
      'dependencies'        => 'Text',
